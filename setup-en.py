...
files_to_copy = [
    ...
    {
        'source': '/data/RoadbuckMods/MaxxFan/files/qml/EN_OverviewMaxxFan.qml',
    ...
    {
        'source': '/data/RoadbuckMods/MaxxFan/files/qml/EN_PageSettingsRoadbuckMods.qml',
        'destination': '/opt/victronenergy/gui/qml/PageSettingsRoadbuckMods.qml'
    },
    {
        'source': '/data/RoadbuckMods/MaxxFan/files/qml/EN_PageSettingsRoadbuckStarterBattery.qml',
        'destination': '/opt/victronenergy/gui/qml/PageSettingsRoadbuckStarterBattery.qml'
    },
    {
        'source': '/data/RoadbuckMods/MaxxFan/files/qml/EN_PageSettingsRoadbuckTruma.qml',
        'destination': '/opt/victronenergy/gui/qml/PageSettingsRoadbuckTruma.qml'
    },
    {
        'source': '/data/RoadbuckMods/MaxxFan/files/qml/EN_PageSettingsRoadbuckMaxxFan.qml',
        'destination': '/opt/victronenergy/gui/qml/PageSettingsRoadbuckMaxxFan.qml'
    },
    {
        'source': '/data/RoadbuckMods/MaxxFan/files/qml/EN_PageSettingsRoadbuckShelly.qml',
        'destination': '/opt/victronenergy/gui/qml/PageSettingsRoadbuckShelly.qml'
    },
    {
        'source': '/data/RoadbuckMods/MaxxFan/files/qml/EN_PageSettingsRoadbuckTeltonika.qml',
        'destination': '/opt/victronenergy/gui/qml/PageSettingsRoadbuckTeltonika.qml'
    },
    {
        'source': '/data/RoadbuckMods/MaxxFan/files/qml/EN_PageSettingsRoadbuckWeather.qml',
...
source_files = [
    ...
    '/opt/victronenergy/gui/qml/PageSettingsMaxxFan.qml',
